...
export default function MatchLoader() {
	...
	useEffect(() => {
		// Запускаем первый поворот сразу через requestAnimationFrame
	...
	// Позиции букв в зависимости от rotation
	const getLetterPosition = (index: number) => {
		const positions = [
			{ top: 0, left: 0 }, // Верхний левый
			{ top: 0, left: 1 }, // Верхний правый
			{ top: 1, left: 1 }, // Нижний правый
			{ top: 1, left: 0 }, // Нижний левый
		]
